...
import (
	...
	"github.com/nachoperator/nacho-operators/cert-monitor-operator/pkg/notifications"
	"github.com/nachoperator/nacho-operators/cert-monitor-operator/pkg/utils"
...
//+kubebuilder:rbac:groups=certmonitor.nachoperator.io,resources=certificatemonitors,verbs=get;list;watch;update;patch
//+kubebuilder:rbac:groups=certmonitor.nachoperator.io,resources=certificatemonitors/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=certmonitor.nachoperator.io,resources=certificatemonitors/finalizers,verbs=update
